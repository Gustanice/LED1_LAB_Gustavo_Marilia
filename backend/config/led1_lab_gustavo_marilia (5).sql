...
CREATE TABLE `admin` (
  ...
  `primeiro_login` tinyint(4) DEFAULT 1
...
--
ALTER TABLE `requisicoes`
  MODIFY `ID_requisicao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `requisicoes`
  ADD CONSTRAINT `requisicoes_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`ID_admin`),
  ADD CONSTRAINT `requisicoes_ibfk_2` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`ID_produto`);
COMMIT;
